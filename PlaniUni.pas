...
type
  TPlaniForm = class(TForm)
    ...
    CapCl1: TMenuItem;
    Anlises1: TMenuItem;
    Multianlise1: TMenuItem;
    Multigrficos1: TMenuItem;
    ...
    procedure Multianlise1Click(Sender: TObject);
    procedure Multigrficos1Click(Sender: TObject);
...
procedure TPlaniForm.ClipboardChanged;
begin
...
procedure TPlaniForm.Open(const AFileName: string);
var i:SmallInt;
begin
i:=4;
PathPlani:=AFileName;
...
procedure TPlaniForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
Form1.AjeitarSaida;
Action:=caFree;
end;

procedure TPlaniForm.FormActivate(Sender: TObject);
begin
...
procedure TPlaniForm.FormCloseQuery(Sender: TObject;var CanClose: Boolean);
begin
...
procedure TPlaniForm.Novo1Click(Sender: TObject);
begin
Form1.Novo1Click(Sender);
end;

procedure TPlaniForm.FormShortCut(var Msg: TWMKey; var Handled: Boolean);
var i,j:integer;
begin
...
procedure TPlaniForm.Abrir1Click(Sender: TObject);
begin
Form1.Abrir1Click(Sender);
end;

procedure TPlaniForm.Salvar1Click(Sender: TObject);
var i:SmallInt;
begin
i:=4;
if PathPlani='Sem nome' then SalvarComo1Click(Sender) else begin
 F1.Write(PathPlani,i);
 F1.Modified:=False;
 Form1.FST1.Panels[1].Text:='';
end;
end;

procedure TPlaniForm.Salvarcomo1Click(Sender: TObject);
begin
SaveDialog1.FileName:=PathPlani;
if SaveDialog1.Execute then begin
 PathPlani:=SaveDialog1.FileName;
 Caption:=PathPlani;
 Salvar1Click(Sender);
 F1.Modified:=False;
 Form1.FST1.Panels[1].Text:='';
...
procedure TPlaniForm.Sair1Click(Sender: TObject);
begin
Form1.Sair1Click(Sender);
end;

procedure TPlaniForm.Recortar1Click(Sender: TObject);
begin
F1.EditCut;
ClipboardChanged;
end;

procedure TPlaniForm.Copiar1Click(Sender: TObject);
begin
F1.EditCopy;
ClipboardChanged;
end;

procedure TPlaniForm.Colar1Click(Sender: TObject);
begin
F1.EditPasteValues;
end;

procedure TPlaniForm.Fechar1Click(Sender: TObject);
begin
Close;
end;

procedure TPlaniForm.Configurarimpressora1Click(Sender: TObject);
begin
Form1.PSTD1.Execute;
end;

procedure TPlaniForm.Configurarpgina1Click(Sender: TObject);
begin
Form1.Configurarpgina1Click(Sender);
end;

procedure TPlaniForm.Imprimirseleoatual1Click(Sender: TObject);
var Ini: TRegIniFile;
begin
...
procedure TPlaniForm.Inserir1Click(Sender: TObject);
begin
try
...
procedure TPlaniForm.Excluir1Click(Sender: TObject);
begin
if Pos('16384',F1.Selection)>0 then begin
 F1.EditDelete(4);
 Exit;
...
procedure TPlaniForm.Limparcontedo1Click(Sender: TObject);
begin
F1.EditClear(F1ClearAll);
end;

procedure TPlaniForm.Fonte1Click(Sender: TObject);
begin
F1.FormatFontDlg;
end;

procedure TPlaniForm.Alinhamento1Click(Sender: TObject);
...
procedure TPlaniForm.Inserir2Click(Sender: TObject);
begin
F1.InsertSheets(F1.Sheet,1);
F1.SheetName[F1.Sheet]:='Plan'+IntToStr(F1.NumSheets);
end;

procedure TPlaniForm.Excluir2Click(Sender: TObject);
begin
...
procedure TPlaniForm.Renomear1Click(Sender: TObject);
var S:String;
begin
...
procedure TPlaniForm.AddCl1Click(Sender: TObject);
var Ini:TReginifile;
i,j:integer;
begin
Ini:=TRegIniFile.Create('\Software\'+Application.Title);
...
procedure TPlaniForm.CapCl1Click(Sender: TObject);
var Ini:TReginifile;
i:integer;
begin
Ini:=TRegIniFile.Create('\Software\'+Application.Title);
...
procedure TPlaniForm.Barradeferramentas1Click(Sender: TObject);
begin
Form1.Barradeferramentas1Click(Self);
end;

procedure TPlaniForm.F1SelChange(Sender: TObject);
begin
Form1.FST1.Panels[0].Text:=F1.Selection;
end;

procedure TPlaniForm.F1Modified(Sender: TObject);
begin
Form1.FST1.Panels[1].Text:='Modificado';
end;

procedure TPlaniForm.Fechartodas1Click(Sender: TObject);
begin
Form1.FecharTodas;
end;

procedure TPlaniForm.Editar1Click(Sender: TObject);
begin
ClipboardChanged;
end;

procedure TPlaniForm.Barradeestatus1Click(Sender: TObject);
begin
Form1.Barradeestatus1Click(Self);
end;

procedure TPlaniForm.Arquivo1Click(Sender: TObject);
begin
Form1.Arquivo1Click(Self);
Form1.MRU1.RecentMenu:=Arquivo1;
end;

procedure TPlaniForm.Larguradascolunas1Click(Sender: TObject);
var ap:SmallInt;
begin
...
procedure TPlaniForm.Alturadaslinhas1Click(Sender: TObject);
var ap:SmallInt;
begin
with TColunaForm.Create(Self) do try
 Caption:='Linhas';
...
procedure TPlaniForm.Multianlise1Click(Sender: TObject);
begin
Form1.Analisar;
end;

procedure TPlaniForm.Multigrficos1Click(Sender: TObject);
begin
Form1.Graficos;
end;

procedure TPlaniForm.PopupMenu1Popup(Sender: TObject);
begin
ClipboardChanged;
end;
